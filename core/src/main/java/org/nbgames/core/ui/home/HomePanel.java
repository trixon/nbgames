...
public class HomePanel extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        playerSystemItem.setImage(GraphicsHelper.toBufferedImage(MaterialIcon._Social.PEOPLE.getImageIcon(96).getImage()));
        ...
        pluginSystemItem.setImage(GraphicsHelper.toBufferedImage(MaterialIcon._Av.GAMES.getImageIcon(96).getImage()));
...
//            builder.append("<h1>").append(Dict.Game.NO_INSTALLED_GAMES.toString()).append("</h1>");
        } else {
