...
public final class PlayersPanel extends javax.swing.JPanel {
    ...
    private void init() {
        mDialogOkButton = new JButton(MaterialIcon._Action.DONE.getImageIcon(Almond.ICON_LARGE));
        mDialogCancelButton = new JButton(MaterialIcon._Navigation.CLOSE.getImageIcon(Almond.ICON_LARGE));
        mDialogOptions = new Object[]{mDialogCancelButton, mDialogOkButton};

        addButton.setIcon(MaterialIcon._Content.ADD.getImageIcon(mIconSize));
        editButton.setIcon(MaterialIcon._Content.CREATE.getImageIcon(mIconSize));
        removeButton.setIcon(MaterialIcon._Content.REMOVE.getImageIcon(mIconSize));
        removeAllButton.setIcon(MaterialIcon._Content.CLEAR.getImageIcon(mIconSize));
    }
